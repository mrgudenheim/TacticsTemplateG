...
@export var base_power_formula: FormulaData = FormulaData.new(FormulaData.Formulas.PA_X_V1, [5, 0], FormulaData.FaithModifier.NONE, FormulaData.FaithModifier.NONE, true, true)
